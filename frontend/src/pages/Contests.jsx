    ...
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      <div className="mx-auto max-w-7xl px-6 py-10">
        ...
        <div className="rounded-2xl border border-indigo-500/40 bg-gradient-to-r from-indigo-900/40 to-slate-900 p-8">
          ...
          <Link
            to={`/contests/${runningContest.id}`}
            className="mt-8 flex w-fit items-center gap-2 rounded-lg bg-indigo-500 px-6 py-3 font-semibold hover:bg-indigo-400 transition"
          >
          ...
          {upcomingContests.map((contest) => (
            ...
            >
              ...
              <Link
                ...
                className="mt-6 flex w-fit items-center gap-2 rounded-lg bg-indigo-500 px-5 py-2 font-medium hover:bg-indigo-400 transition"
              >
              ...
              {pastContests.map((contest) => (
                ...
                >
                  ...
                  <td>
                    ...
                    <Link
                      to={`/contests/${contest.id}`}
                      className="flex w-fit items-center gap-2 rounded-lg border border-slate-700 px-4 py-2 hover:bg-slate-800 transition"
                    >
